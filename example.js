...
const bookList = [
  ...
  */
  ...
  //const emmaBook = {title: "Emma", author: "Jane Austen"};
  //addBook(emmaBook);
  ...
  const listAuthors = () => {return bookList.map(book => book.author);};
  ...
  const isPosOrNeg = (num) => {num > 0 ? "positive" : "negative";};
  ...
  /* (5) Write a switch statement for a 'day' variable that prints out something based off of what day of
    ...
    switch(day) {
        ...
        case 'Wednesday':
            console.log("wing wednesday");
        case 'Thursday':
            console.log("hump day or whatever that means");
        case 'Friday':
            console.log("tgif");
        default:
            console.log("weekender");
    }
